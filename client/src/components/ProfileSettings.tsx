  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-4">
        ...
        <button className="rounded-lg border border-[rgb(var(--border))] px-3 py-1.5 text-xs hover:bg-[rgb(var(--surface-hover))]">
          Change
        </button>
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div>
          ...
          <select className="w-full rounded-lg border border-[rgb(var(--border))] bg-transparent px-3 py-2 text-sm outline-none">
            <option>INR</option>
            <option>USD</option>
            <option>EUR</option>
          </select>
