        ...
        <div>
          <div className="flex flex-col gap-8 md:flex-row md:items-center">
            ...
            <div className="shrink-0">
              <div className="h-70 w-70 overflow-hidden rounded-2xl border border-[rgb(var(--border))]">
                <img
            ...
            <div className="flex-1 space-y-3">
              <span className="px-4 py-1 rounded-2xl text-xs font-semibold uppercase tracking-widest border border-[rgb(var(--border))] text-[rgb(var(--primary))]">
                Founder & Developer
              </span>
...
<div className="rounded-2xl p-6">
  ...
  <div className="flex flex-wrap gap-3">
    {/* GitHub */}
    <button className="flex items-center gap-2 rounded-lg border border-[rgb(var(--border))] px-4 py-2 text-sm text-[rgb(var(--text))] transition hover:bg-[rgb(var(--surface))] active:scale-[0.98]">
      <Link size={18} />
      GitHub
    </button>
